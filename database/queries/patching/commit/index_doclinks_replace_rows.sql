...
--                             - key columns (doc_type, doc_id, link_type, link_subtype, link_id)
...
-- columns, and generate both clauses from the remaining columns.
    UPDATE [[graphsearch_prod_mirror]].Index_D_[[doc_type]]_L_[[link_type]]_T_[[sem_or_org]][[special_suffix]] p
INNER JOIN        [[graphsearch_test]].Index_D_[[doc_type]]_L_[[link_type]]_T_[[sem_or_org]][[special_suffix]] t
