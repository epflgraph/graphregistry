...
CREATE OR REPLACE VIEW graph_lectures.Edges_N_Course_N_Concept_T_SlideSumScores AS
       ...
       SELECT DISTINCT t3.from_institution_id AS institution_id,
            ...
            INNER JOIN graph_lectures.Edges_N_Course_N_Lecture_T_ParentToChild t3
