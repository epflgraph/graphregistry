-- =================== Lecture to concept edges (by aggregating slide-concept scores)
CREATE OR REPLACE VIEW graph_lectures.Edges_N_Lecture_N_Concept_T_SlideSumScores_UD AS
            ...
            INNER JOIN graph_registry.Operations_N_Object_T_ScoresExpired t3
