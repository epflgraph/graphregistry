...
CREATE TABLE `Data_N_Object_N_Object_T_CalculatedFields` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Data_N_Object_T_CalculatedFields` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Course_N_Concept_T_SlideSumScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Course_N_Lecture_T_ParentToChild` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Lecture_N_Concept_T_SlideSumScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Lecture_N_Concept_T_Timestamps` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Lecture_N_Video_T_ParentToChild_Enriched` (
...
CREATE TABLE `Edges_N_MOOC_N_Concept_T_SlideSumScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_MOOC_N_Lecture_T_ParentToChild` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Category_T_CalculatedScores_AVG` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Category_T_CalculatedScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Category_T_FinalScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `category_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Concept_T_CalculatedScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Concept_T_FinalScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Concept_T_ScoringMatrix` (
...
CREATE TABLE `Edges_N_Object_N_Concept_T_Tuples` (
...
CREATE TABLE `Edges_N_Object_N_Concept_T_UnionAllScores` (
...
CREATE TABLE `Edges_N_Object_N_CuratedArea_T_CalculatedScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_CuratedArea_T_FinalScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `curated_area_id` varchar(255) NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_CalculatedScores` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_DegreeCombinations` (
...
CREATE TABLE `Edges_N_Object_N_Object_T_MaxLogDegrees` (
...
CREATE TABLE `Edges_N_Object_N_Object_T_NormLogDegrees` (
  `from_institution_id` varchar(5) NOT NULL DEFAULT '',
  `from_object_type` varchar(17) NOT NULL DEFAULT '',
  `from_object_id` varchar(255) NOT NULL DEFAULT '',
  `to_institution_id` varchar(5) NOT NULL DEFAULT '',
...
CREATE TABLE `Edges_N_Object_N_Object_T_ParentChildSymmetric` (
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_AVG` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `to_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_Education_AS` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_Education_GBC` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_Ontology_AS` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_Ontology_GBC` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_Research_AS` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Edges_N_Object_N_Object_T_ScoresMatrix_Research_GBC` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `graph_lectures_Operations_N_Object_N_Object_T_FieldChecksums` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `graph_lectures_Operations_N_Object_T_FieldChecksums` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
...
CREATE TABLE `graph_registry_Operations_N_Object_N_Object_T_FieldChecksums` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `graph_registry_Operations_N_Object_T_FieldChecksums` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  `calculation_type` enum('object fields','object node','page profile') NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Category` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Concept` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Course` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Exercise` (
...
CREATE TABLE `IndexBuildup_Fields_Docs_Lecture` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_MOOC` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Notebook` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Person` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Publication` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Startup` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Unit` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Docs_Widget` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Links_ParentChild_Course_Lecture` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `IndexBuildup_Fields_Links_ParentChild_Course_Person` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` varchar(8) NOT NULL,
  `doc_type` varchar(16) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Links_ParentChild_Lecture_MOOC` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` varchar(8) NOT NULL,
  `doc_type` varchar(16) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexBuildup_Fields_Links_ParentChild_Person_Unit` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` varchar(8) NOT NULL,
  `doc_type` varchar(16) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Category` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `IndexRollback_Fields_Docs_Concept` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Course` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Lecture` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_MOOC` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Person` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Publication` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Startup` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Unit` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Docs_Widget` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Links_ParentChild_Course_Person` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_Fields_Links_ParentChild_Person_Unit` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `IndexRollback_PageProfile` (
  `rollback_date` date NOT NULL,
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  ...
  `external_url_de` varchar(255) DEFAULT NULL,
  `external_url_it` varchar(255) DEFAULT NULL,
...
CREATE TABLE `IndexRollback_ScoreRanks_Links` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `rollback_date` date NOT NULL,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
...
CREATE TABLE `Migration_New_Infoscience_Ids` (
...
CREATE TABLE `Nodes_N_Concept_T_InUse` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  PRIMARY KEY (`institution_id`,`object_type`,`object_id`),
...
CREATE TABLE `Nodes_N_Object_T_DegreeScores` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `Operations_N_Object_N_Object_T_FieldsRandomSet` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Operations_N_Object_N_Object_T_ScoresRandomSet` (
  `from_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `from_object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `from_object_id` varchar(255) NOT NULL,
  `to_institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Operations_N_Object_T_FieldsRandomSet` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  PRIMARY KEY (`institution_id`,`object_type`,`object_id`),
...
CREATE TABLE `Operations_N_Object_T_ScoresRandomSet` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `object_type` enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') NOT NULL,
  `object_id` varchar(255) NOT NULL,
  PRIMARY KEY (`institution_id`,`object_type`,`object_id`),
...
CREATE TABLE `_TEMP_Map_Concept_To_Category` (
...
CREATE TABLE `Traversal_N_Concept_N_Concept_T_Depth2` (
...
CREATE TABLE `Traversal_N_MOOC_N_Person_N_Publication_N_Concept_T_ConceptDet` (
  `institution_id` varchar(6) NOT NULL,
...
CREATE TABLE `Traversal_N_MOOC_N_Publication_N_Concept_T_ConceptDetection` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Traversal_N_Person_N_Publication_N_Concept_T_ConceptDetection` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Traversal_N_Person_N_Publication_T_Authorship` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `person_id` varchar(255) NOT NULL,
  `publication_id` varchar(255) NOT NULL,
...
CREATE TABLE `Traversal_N_Publication_N_Concept_T_ConceptDetection` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `publication_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
  `score` float NOT NULL,
...
CREATE TABLE `Traversal_N_Unit_N_Person_T_Affiliation` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
...
CREATE TABLE `Traversal_N_Unit_N_Publication_N_Concept_T_ConceptDetection` (
  `institution_id` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `unit_id` varchar(255) NOT NULL,
  `publication_id` varchar(255) NOT NULL,
  `concept_id` varchar(255) NOT NULL,
