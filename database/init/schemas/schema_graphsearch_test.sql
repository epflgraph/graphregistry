...
CREATE TABLE `Index_D_Category_L_Category_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Concept_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Course_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Lecture_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_MOOC_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Notebook_T_SEM` (
...
CREATE TABLE `Index_D_Category_L_Person_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Publication_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Startup_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Unit_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Category_L_Widget_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Category_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Course_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Lecture_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_MOOC_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Notebook_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Person_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Publication_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Startup_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Unit_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Concept_L_Widget_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_Course_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_Lecture_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_Lecture_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_MOOC_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Course_L_Person_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Concept_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Concept_T_ORG_Search` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Course_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Course_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Lecture_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_MOOC_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_MOOC_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Person_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Widget_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Lecture_L_Widget_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_Course_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_Lecture_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_Lecture_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_MOOC_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_MOOC_L_Person_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Notebook_L_Category_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Notebook_L_Concept_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Notebook_L_Notebook_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Notebook_L_Person_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Course_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_MOOC_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Notebook_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Person_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Publication_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Publication_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Startup_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Unit_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Person_L_Unit_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Person_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Person_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Publication_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Startup_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Publication_L_Unit_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Startup_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Startup_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Startup_L_Person_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Startup_L_Publication_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Startup_L_Startup_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Startup_L_Unit_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Person_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Person_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Publication_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Startup_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Unit_T_ORG` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Unit_L_Unit_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Widget_L_Category_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Widget_L_Concept_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
...
CREATE TABLE `Index_D_Widget_L_Lecture_T_ORG` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Widget_L_Lecture_T_SEM` (
  `doc_institution` varchar(16) NOT NULL,
  `doc_type` varchar(64) NOT NULL,
  `doc_id` varchar(255) NOT NULL,
  `link_institution` varchar(16) NOT NULL,
...
CREATE TABLE `Index_D_Widget_L_Widget_T_SEM` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_institution` enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') NOT NULL,
  `doc_type` enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Specialisation','Startup','Strategic area','StudyPlan','Unit','Widget') NOT NULL,
  `doc_id` varchar(255) NOT NULL,
