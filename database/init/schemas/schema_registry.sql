...
CREATE TABLE IF NOT EXISTS Edges_N_Object_N_Concept_T_ConceptDetection (
  ...
  text_source enum('abstract', 'audio transcription', 'biography', 'course page description', 'exercise description', 'lecture description', 'llm generated', 'mooc description', 'notebook description', 'ocr content', 'quiz description', 'startup website', 'studyplan website', 'transcript text', 'unit website') NOT NULL,
