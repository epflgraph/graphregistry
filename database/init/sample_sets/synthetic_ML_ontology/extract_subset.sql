...
DROP TABLE IF EXISTS [[ontology_light]]._concept_ids;
        CREATE TABLE [[ontology_light]]._concept_ids AS
     SELECT DISTINCT concept_id
                FROM [[registry]].Edges_N_Object_N_Concept_T_ConceptDetection;
     
                  -- List of categories to keep
DROP TABLE IF EXISTS [[ontology_light]]._category_ids;
        CREATE TABLE [[ontology_light]]._category_ids AS
