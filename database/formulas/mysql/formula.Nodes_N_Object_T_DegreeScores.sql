...
-- ================================= --
        ...
        REPLACE INTO graph_cache.Edges_N_Object_N_Object_T_DegreeCombinations
              SELECT e.from_institution_id, e.from_object_type, e.from_object_id, e.to_institution_id, e.to_object_type,
                ...
                FROM graph_registry.Edges_N_Object_N_Object_T_ChildToParent e
          ...
          INNER JOIN graph_airflow.Operations_N_Object_T_TypeFlags tf
               ...
               WHERE se.to_process = 1
                 AND tf.to_process = 1
            GROUP BY e.from_institution_id, e.from_object_type, e.from_object_id, e.to_object_type;
        ...
        REPLACE INTO graph_cache.Edges_N_Object_N_Object_T_DegreeCombinations
          ...
          INNER JOIN graph_airflow.Operations_N_Object_T_TypeFlags tf
               ...
               WHERE se.to_process = 1
                 AND tf.to_process = 1
            GROUP BY e.to_institution_id, e.to_object_type, e.to_object_id, e.from_object_type;
        ...
        REPLACE INTO graph_cache.Edges_N_Object_N_Object_T_DegreeCombinations
              SELECT e.to_institution_id, e.to_object_type, e.to_object_id, e.from_institution_id, e.from_object_type,
                             COUNT(DISTINCT e.from_object_id)  AS degree,
                     LOG(1 + COUNT(DISTINCT e.from_object_id)) AS log_degree
                FROM graph_lectures.Edges_N_Object_N_Object_T_ChildToParent e
          INNER JOIN graph_airflow.Operations_N_Object_T_ScoresExpired se
                  ON (  se.institution_id,   se.object_type,   se.object_id)
                   = (e.to_institution_id, e.to_object_type, e.to_object_id)
          INNER JOIN graph_airflow.Operations_N_Object_T_TypeFlags tf
        ...
        --         FROM graph_lectures.Edges_N_Lecture_N_Concept_T_SlideSumScores_UD t
