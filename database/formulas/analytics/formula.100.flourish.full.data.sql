...
CREATE TABLE IF NOT EXISTS graph_analytics._flourish_temp (
...
CREATE TABLE graph_analytics.Flourish_CS_119_Full_Data (
    root varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    category_name_1 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    category_name_2 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    category_name_3 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    category_name_4 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    is_cs_119_concept tinyint(4) NOT NULL DEFAULT 0,
    study_plan_id varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    study_plan_name mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    study_plan_level mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    score double DEFAULT NULL,
    row_id int(10) unsigned NOT NULL AUTO_INCREMENT,
    PRIMARY KEY (row_id),
    UNIQUE KEY unique_key (course_code,concept_id,study_plan_id)
