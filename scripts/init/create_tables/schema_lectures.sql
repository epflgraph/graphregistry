...
CREATE TABLE IF NOT EXISTS Data_N_Object_N_Object_T_CustomFields (
  ...
  from_object_type enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  to_object_type enum('Category','Chart','Concept','Course','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') COLLATE utf8mb4_unicode_ci NOT NULL,
  to_object_id varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  context enum('part of','accreditation','affiliation','authorship','coursebook','teacher') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS Edges_N_Object_N_Concept_T_ConceptDetection (
  ...
  text_source enum('ocr content','transcript text') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS Nodes_N_Object (
  institution_id enum('Ont','EPFL','ETHZ','PSI','Empa','Eawag','WSL') COLLATE utf8mb4_unicode_ci NOT NULL,
  is_eth_domain tinyint unsigned NOT NULL,
  object_type enum('Category','Chart','Concept','Course','Curated area','Dashboard','Exercise','External person','Hardware','Historical figure','Lecture','Learning module','MOOC','News','Notebook','Person','Publication','Slide','Specialisation','Startup','Strategic area','StudyPlan','Transcript','Unit','Widget') COLLATE utf8mb4_unicode_ci NOT NULL,
  object_id varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  object_title text COLLATE utf8mb4_unicode_ci,
  object_authors text COLLATE utf8mb4_unicode_ci,
  object_date date DEFAULT NULL,
  object_year year DEFAULT NULL,
  object_url varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  is_valid_url tinyint unsigned NOT NULL,
  requires_login tinyint unsigned NOT NULL,
  ...
  KEY object_type (object_type),
  KEY object_id (object_id),
  KEY is_eth_domain (is_eth_domain),
  KEY is_valid_url (is_valid_url),
  KEY requires_login (requires_login)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
