...
( ulimit -v $((4*1024*1024)) ; graphregistry airflow expire --doc_type=Unit --older_than=90 --limit_per_type=10 )
( ulimit -v $((4*1024*1024)) ; graphregistry airflow refresh --doc_type=Unit -r -v )
( ulimit -v $((4*1024*1024)) ; graphregistry airflow status )
