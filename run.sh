...
# ( ulimit -v $((4*1024*1024)) ; graphregistry es import --env=xaas_coresrv --input_folder=/home/dockerhost/data/es_exports/2026-02-19/es_fullindex_2026-02-19 --rename_to=graphsearch_test_2026_02_19 -r -f )
