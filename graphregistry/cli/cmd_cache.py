...
#     """
#     Register 'cache' domain commands.
...
#     # >> graphregistry cache cmd [-h|...]
#     subcmd_cache = parser.add_subparsers(
#         dest="cache_cmd",
#         metavar="<command>",
#         required=True,
#         help="Cache subcommand (e.g. 'to_process')."
#     )
...
#     # >> graphregistry cache to_process [-h|...]
#     parser_cache_to_process = subcmd_cache.add_parser(
#         "to_process",
#         help="Operations on the 'to process' queue for cache jobs."
#     )

#     # Register mutually exclusive arguments
#     # >> graphregistry cache to_process --count | --reset
#     group_cache_to_process = parser_cache_to_process.add_mutually_exclusive_group(required=True)

#     # Register --count argument
#     # >> graphregistry cache to_process --count
#     group_cache_to_process.add_argument(
#         "--count",
#         action="store_true",
...
#     # Bind handler
#     parser_cache_to_process.set_defaults(func=cmd_cache_to_process)
